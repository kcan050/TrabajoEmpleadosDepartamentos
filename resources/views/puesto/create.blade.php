...
<div class="col-lg-8 col-xlg-9 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <form action="{{ url('puesto') }}" method="post" class="form-horizontal form-material">
                                    @csrf
                                    @method('post')
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="number" value="{{ old('minimo') }}"name="minimo" placeholder="Minimo"
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="number" name="maximo" value="{{ old('maximo') }}" placeholder="Maximo"
                                                class="form-control p-0 border-0"
                                                id="example-email">
                                        </div>
                                    </div>
